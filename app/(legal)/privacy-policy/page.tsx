        ...
        <Wrapper>
            <div className="my-24">
                ...
                <P>
                    ...
                    any data with which you can be personally identified. For detailed
                ...
                <P>
                    ...
                    operator. You can find their contact details in the section &#34;Notice on
                    the Responsible Party&#34; in this privacy policy.
                </P>{" "}
                <H4>How do we collect your data?</H4>
                <P>
                    Your data is collected firstly when you provide it to us. This could
                    be data that you enter in a contact form.
                </P>{" "}
                <P>
                    Other data is automatically collected or obtained through your consent
                    when you visit the website. This data is primarily technical (e.g.,
                    internet browser, operating system, or the time of page access). This
                ...
                <P>
                    ...
                    recipients, and purpose of your stored personal data at any time free
                    of charge. You also have the right to request the correction or
                    deletion of this data. If you have given consent for data processing,
                    you can withdraw this consent at any time for the future. Furthermore,
                    you have the right to request the restriction of processing your
                    personal data under certain circumstances. Additionally, you have the
                    right to lodge a complaint with the competent supervisory authority.
                </P>{" "}
                <P>
                    You can contact us at any time regarding these and other questions
                ...
                <H3>Strato</H3>{" "}
                <P>
                    The provider is Strato AG, Otto-Ostrowski-Strasse 7, 10249 Berlin
                ...
                <P>
                    ...
                    interest in the most reliable possible presentation of our website. If
                    a corresponding consent has been requested, the processing is carried
                    out exclusively based on Art. 6(1)(a) GDPR and § 25(1) TDDG, insofar
                    as the consent includes the storage of cookies or access to
                    information on the user’s device (e.g., device fingerprinting) as
                    defined by the TDDG. Consent can be revoked at any time.
                </P>{" "}
                <H4>Order Processing</H4>{" "}
                <P>
                    We have concluded a contract for order processing (AVV) with the
                    above-mentioned provider. This is a data protection-related contract
                    required by law, which ensures that this provider processes the
                    personal data of our website visitors only according to our
                ...
                <P>
                    ...
                    Email:{" "}
                    <Link
                        href={"mailto:" + process.env.LEGAL_EMAIL}
                        className="inline-link inline-link-resting"
                    >
                ...
                <P>
                    ...
                    purpose for the data processing no longer applies. If you make a
                    legitimate request for deletion or withdraw your consent to data
                    ...
                    commercial law retention periods); in the latter case, deletion will
                ...
                <P>
                    ...
                    categories of data are processed according to Art. 9(1) GDPR. In the
                    case of express consent to the transfer of personal data to third
                    countries, data processing is also carried out based on Art. 49(1)(a)
                    ...
                    processing is also based on § 25(1) TDDG. Consent can be revoked at
                    any time. If your data is necessary for contract fulfillment or for
                    carrying out pre-contractual measures, we process your data based on
                    Art. 6(1)(b) GDPR. Furthermore, we process your data if it is
                    necessary for the fulfillment of a legal obligation based on Art.
                    6(1)(c) GDPR. Data processing may also be based on our legitimate
                    interest according to Art. 6(1)(f) GDPR. The respective legal bases
                    for each individual case are explained in the following sections of
                    this privacy policy.
                </P>{" "}
                <H3>Recipients of Personal Data</H3>{" "}
                <P>
                    In the course of our business activities, we work with various
                    external parties. This may require the transfer of personal data to
                    external parties. We only transfer personal data to external parties
                    if it is necessary for the fulfillment of a contract, if we are
                    legally obligated to do so (e.g., transfer of data to tax
                    authorities), if we have a legitimate interest based on Art. 6(1)(f)
                    GDPR, or if another legal basis allows the data transfer. When using
                    data processors, we only transfer personal data of our customers based
                    on a valid contract for order processing. In the case of joint
                ...
                <P>
                    ...
                    consent. You can revoke your consent at any time. The legality of the
                ...
                <P>
                    IF THE DATA PROCESSING IS BASED ON ART. 6(1)(E) OR (F) GDPR, YOU HAVE
                    THE RIGHT TO OBJECT TO THE PROCESSING OF YOUR PERSONAL DATA AT ANY
                    TIME FOR REASONS ARISING FROM YOUR PARTICULAR SITUATION; THIS ALSO
                    APPLIES TO PROFILING BASED ON THESE PROVISIONS. THE RESPECTIVE LEGAL
                    BASIS FOR PROCESSING CAN BE FOUND IN THIS PRIVACY POLICY. IF YOU
                    ...
                    THAT OVERRIDE YOUR INTERESTS, RIGHTS, AND FREEDOMS OR THE PROCESSING
                    SERVES TO ASSERT, EXERCISE, OR DEFEND LEGAL CLAIMS (OBJECTION UNDER
                    ART. 21(1) GDPR).
                </P>{" "}
                <P>
                    ...
                    PERSONAL DATA FOR SUCH MARKETING; THIS ALSO APPLIES TO PROFILING, TO
                    THE EXTENT THAT IT IS RELATED TO SUCH DIRECT MARKETING. IF YOU OBJECT,
                    YOUR PERSONAL DATA WILL NO LONGER BE USED FOR DIRECT MARKETING
                    PURPOSES (OBJECTION UNDER ART. 21(2) GDPR).
                </P>{" "}
                <H3>
                    Right to Lodge a Complaint with the Competent Supervisory Authority
                </H3>{" "}
                <P>
                    ...
                    member state of their habitual residence, place of work, or the place
                    of the alleged violation. This right exists without prejudice to other
                ...
                <P>
                    ...
                    this will only take place to the extent technically feasible.
                </P>{" "}
                ...
                <P>
                    ...
                    inquiries that you send to us as the site operator. You can recognize
                ...
                <P>
                    ...
                    the browser’s address line changes from &#34;http://&#34; to &#34;https://&#34; and by
                ...
                <P>
                    ...
                    right at any time to obtain free information about your stored
                    ...
                    this data. You can contact us at any time for this purpose and for
                ...
                <ul>
                    ...
                    <li>
                        If you have lodged an objection according to Art. 21(1) GDPR, a
                ...
                <P>
                    ...
                    may only be processed – apart from its storage – with your consent or
                    for the assertion, exercise, or defense of legal claims, for the
                    protection of another natural or legal person, or for reasons of
                    significant public interest of the European Union or a member state.
                </P>
            </div>
        </Wrapper>
    );
