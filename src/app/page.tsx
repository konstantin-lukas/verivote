                    ...
                    <div className="relative flex h-full items-center">
                        ...
                        <div className="md:w-1/2 md:-translate-y-16 [@media(max-height:530px)]:translate-y-0">
                            ...
                            <p className="my-2 leading-relaxed [@media(max-height:420px)]:hidden">
                                Want to create a poll and try out different
                                voting methods? We’ve got you covered! From
                                ranked choice to approval voting, we make it
                                easy to build and share polls with friends, and
                                we’ll even help you learn how each method works
                                along the way. Let’s make voting more fun and
                                easy together!
                            </p>
                            <ScrollDownButton />
                        </div>
